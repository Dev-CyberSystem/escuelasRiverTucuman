      ...
      <Row>
        ...
        <Col>
          <h1>FILOSOFIA RIVER</h1>
           <p>
            Más alla de sostener <b>"El Mas Grande"</b> , River quiere definirse por sus valores y sus valores tienen que ver con <b>"Vivir y Jugar con Grandeza"</b>, que abarca más que ser <b>"El Mas Grande"</b>. Porque la grandeza no esta al final del camino. Las formas, as convicciones, la manera de llegar a lo que te propones. <br />
          ...
          <p>
            ...
            Ser una institucion ejemplar por su excelentecia deportiva y su compromiso con el juego limpio, la educación, la cultura y la acción social.
          </p>
          <p>
          <img src={escudo} alt=""  className="escudoObjetivos"/> {""}
