...
//       return { ...alumno, mesesAdeudados };
//     }).filter(alumno => alumno.mesesAdeudados.length > 0);
...
//         ({ valor }) => !mesesPagados.includes(valor)
//       );
...
//   console.log(alumnosFiltrados , "alumnosFiltrados!!!!!!!!!!!!!!")
//   return (
//     <Container>
//       <Row className="mt-5">
//         <Col>
...
//                   <td>
//                     {alumno.mesesAdeudados?.map(mes => mes.nombre).join(', ') || "Ninguno"}
...
//                     {alumno.categoria}) debe cuotas: {alumno.mesesAdeudados?.map(mes => mes.nombre).join(', ') || "Ninguno"}
//                   </li>
//                 ))}
//               </ul>
//             </Alert>
